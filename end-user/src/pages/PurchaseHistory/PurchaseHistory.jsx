				...
				<div className='user-information_container'>
					...
					<div className='content'>
						...
						<div className='content_text'>
							Quản lý thông tin các sản phẩm đã mua
						</div>
						<div className='content_product'>
							<div className='content_product_item'>
								<div className='content_product_item_img_info'>
									<div className='content_product_item_img'>
										<img
											src='https://cdn.tgdd.vn/Products/Images/42/245545/iPhone-14-plus-thumb-den-600x600.jpg'
											alt=''
											className=''
										/>
									</div>
									<div className='content_product_item_info'>
										<div className='content_product_item_info_title'>
											Apple iPhone 14 Plus
										</div>
										<div className='content_product_item_info_type'>
											128GB, Purple
										</div>
										<div className='content_product_item_info_amount'>
											x1
										</div>
									</div>
								</div>

								<div className='content_product_item_info_price'>
									29.999.000 đ
								</div>
							</div>
							...
							<div className='content_product_item'>
								<div className='content_product_item_img_info'>
									<div className='content_product_item_img'>
										<img
											src='https://cdn.tgdd.vn/Products/Images/54/236016/bluetooth-airpods-2-apple-mv7n2-imei-1-org.jpg'
											alt=''
											className=''
										/>
									</div>
