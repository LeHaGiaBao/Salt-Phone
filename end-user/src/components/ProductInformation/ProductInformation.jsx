		...
		<div className='main-screen'>
			<div className='main-content'>
				<div className='content'>
					...
					<div className='content_product'>
							...
							<div className='content_product-small-images'>
								<div className='content_product-small-main-img'>
									<img
										src={ProductInfor}
										alt=''
										className='content_product-small-image-full'
									/>
								</div>
								<img
									src={ProductInforSmallImg2}
									alt=''
									className='content_product-small-image'
								/>
								<img
									src={ProductInforSmallImg3}
									alt=''
									className='content_product-small-image'
								/>
								<img
									src={ProductInforSmallImg4}
									alt=''
									className='content_product-small-image'
								/>
							</div>
						...
						<div className='content_product-order'>
							<div className='content_product-order_name'>
							...
							<table className='content_product-order_select'>
								...
								<tr className='content_product-order_select_item'>
									<td className='content_product-order_select_label v-a-top'>
										Bộ nhớ
									</td>
									<td className='content_product-order_select_memory'>
										<div className='content_product-order_select_type'>
											64 GB
										</div>
										<div className='content_product-order_select_type'>
											128 GB
						...
						<div className='content_product-information_item'>
							...
							<div className='content_product-information_detail'>
								...
								<ul className='content_product-information_detail_text'>
									...
									<li>
										iPhone 14 Plus. Nghĩ lớn cùng màn hình
										6,7 inch lớn hơn và thời lượng pin bền
										bỉ cả ngày.
									</li>
									<li>
										Chụp những bức ảnh tuyệt đẹp trong điều
										kiện thiếu sáng và dư sáng cùng hệ thống
										camera kép mới.
									</li>
									<li>
										Phát Hiện Va Chạm một tính năng an toàn
										mới, thay bạn gọi trợ giúp khi cần kíp.
									</li>
								</ul>
							</div>
							...
							<div className='content_product-information_detail'>
								...
								<ul className='content_product-information_detail_text'>
									...
									<li>
										Hệ thống camera tiên tiến cho chất lượng
										ảnh đẹp hơn trong mọi điều kiện ánh sáng
									</li>
									<li>
										Chế độ Điện Ảnh nay đã hỗ trợ 4K Dolby
										Vision tốc độ lên đến 30 fps.
									</li>
									<li>
										Chế độ Hành Động để quay video cầm tay
										mượt mà, ổn định.
									</li>
									<li>
										Công nghệ an toàn quan trọng - Phát Hiện
										Va Chạm thay bạn gọi trợ giúp khi cần
										kíp.
									</li>
									<li>
										Thời lượng pin cả ngày và thời gian xem
										video lên đến 26 giờ.
									</li>
									<li>
										Chip A15 Bionic với GPU 5 lõi để đạt
										hiệu suất siêu nhanh. Mạng di động 5G
										siêu nhanh.
									</li>
									<li>
										Các tính năng về độ bền dẫn đầu như
										Ceramic Shield và khả năng chống nước.
									</li>
									<li>
										iOS 16 đem đến thêm nhiều cách để cá
										nhân hóa, giao tiếp và chia sẻ.
									</li>
								</ul>
							</div>
						</div>
				...
				<div className='other-products'>
					<div className='other-products_title'>Các sản phẩm khác</div>
