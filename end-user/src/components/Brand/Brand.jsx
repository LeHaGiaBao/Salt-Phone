                ...
                <div className="type">
                    <div className="type-filter">
                        <div className="type-item">
                            ...
                            <div className="type-item_icon"><AiOutlineFilter /></div>
                        </div>
                        ...
                        <div className="type-filter_content">
                            <div className="type-filter_brand">
                                ...
                                <div className="type-filter_brand_content">
                                    ...
                                    <li className="type-filter_brand_item">SAMSUNG</li>
                            ...
                            <div className="type-filter_other">
                                <div className="type-filter_price-and-ram">
                                    <div className="type-filter_price">
                                        ...
                                        <div className="type-filter_brand_content type-filter_brand_content-ram">
                                            <li className="type-filter_brand_item">Dưới 3 triệu</li>
                                            <li className="type-filter_brand_item">Từ 3 - 7 triệu</li>
                                            <li className="type-filter_brand_item">Từ 7 - 13 triệu</li>
                                            <li className="type-filter_brand_item">Từ 13 - 20 triệu</li>
                                            <li className="type-filter_brand_item">Trên 20 triệu</li>
                                        </div>
                                    </div>
                                    <div className="type-filter_ram">
                                        <p className="type-filter_title">Dung lượng lưu trữ</p>
                                        <div className="type-filter_brand_content type-filter_brand_content-ram">
                                ...
                                <div className="type-filter_memory-and-battery">
                                    ...
                                    <div className="type-filter_ram">
                                        <p className="type-filter_title">Dung lượng pin</p>
                                        <div className="type-filter_brand_content type-filter_brand_content-ram">
                                            <li className="type-filter_brand_item">Dưới 3000mAh</li>
                                            <li className="type-filter_brand_item">Trên 5000mAh</li>
                                            <li className="type-filter_brand_item">từ 3000 - 5000mAh</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="type-filter_footer">
                                ...
                                <div className="type-filter_footer_result">
                                    <button className="type-filter_footer_result_btn">Xem kết quả</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="type-brand">
                        <div className="type-item">
                            ...
                            <div className="type-item_icon"><AiFillCaretDown></AiFillCaretDown></div>
                        </div>
                    ...
                    <div className="type-memory">
                        <div className="type-item">
                            <div className="type-item_text">Dung lượng lưu trữ</div>
                            <div className="type-item_icon"><AiFillCaretDown></AiFillCaretDown></div>
